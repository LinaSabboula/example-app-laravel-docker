<template>
    <div>
        <heading class="mb-6">Government Manager</heading>
        ...
        >
            ...
            <h1 class="text-white text-4xl text-90 font-light mb-6">
                We're in a black  or are we?
            </h1>
            <h1 class="text-white">This is a new edit</h1>
            <p class="text-white-50% text-lg">
                ...
                <code class="ml-1 border border-80 text-sm font-mono text-white bg-black rounded px-2 py-1">
                    /nova-components/GovernmentManager/resources/js/components/Tool.vue
                </code>
            </p>
        </card>
    </div>
